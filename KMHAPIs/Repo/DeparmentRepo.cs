...
{
    public class DeparmentRepo : IDeparmentRepo
    {
        private readonly IDapper db;
        GenericResponseModel response;

        public DeparmentRepo(IDapper db, GenericResponseModel response)
        {
            this.db = db;
            this.response = response;
        }
        public async Task<GenericResponseModel> GetDeparment()
        {
            try
            {
                DynamicParameters parameters = new DynamicParameters();
                var procedureName = "CRUD_Deparment";
        ...
        public async Task<GenericResponseModel> InsertDeparment(DeparmentRequestModel rm)
        {
            try

            {
                ...
                parameters.Add("@DeparmentName", rm.DeparmentName, DbType.String, ParameterDirection.Input);
                parameters.Add("@Remarks", rm.Remarks, DbType.String, ParameterDirection.Input);
                parameters.Add("@ParentID", rm.ParentID, DbType.String, ParameterDirection.Input);
        ...
        public async Task<GenericResponseModel> UpdateDeparment(DeparmentRequestModel rm)
        {
            try
            {
                var procedureName = "CRUD_Deparment";
        ...
        public async Task<GenericResponseModel> DeleteDeparment(int id, string action)
        {
            try
            {
                var procedureName = "CRUD_Deparment";
                var parameters = new DynamicParameters();
                parameters.Add("@DeparmentID", id, DbType.String, ParameterDirection.Input);
        ...
        public async Task<GenericResponseModel> GetDeparmentByActive(string action)
        {
            try
            {
                var procedureName = "CRUD_Deparment";
