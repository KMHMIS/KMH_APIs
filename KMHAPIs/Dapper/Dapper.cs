...
namespace KMHAPIs.Dapper
{
    public class Dapper : IDapper
    {
        ...
        public Dapper(IConfiguration configuration)
        {
            ...
            Connectionstring = configuration.GetConnectionString("SqlConnection");//  ConfigurationManager.ConnectionStrings["dbconnection"].ConnectionString;
        }
        public void Dispose()
        {
        ...
        public async Task<T> Get<T>(string sp, DynamicParameters parms, CommandType commandType = CommandType.Text)
        {
            ...
            var res = await db.QueryFirstOrDefaultAsync<T>(sp, parms, commandType: commandType);
            db.Close();
            return res;
        }
        ...
        private List<object> GetMultiple(string sql, object parameters, params Func<SqlMapper.GridReader, object>[] readerFuncs)
        {
        ...
        //public Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>, IEnumerable<T7>, IEnumerable<T8>> GetMultipleObjects<T1, T2, T3, T4, T5, T6, T7, T8>(string sql, object parameters, Func<GridReader, IEnumerable<T1>> func1, Func<GridReader, IEnumerable<T2>> func2, Func<GridReader, IEnumerable<T3>> func3, Func<GridReader, IEnumerable<T4>> func4, Func<GridReader, IEnumerable<T5>> func5, Func<GridReader, IEnumerable<T6>> func6, Func<GridReader, IEnumerable<T7>> func7, Func<GridReader, IEnumerable<T8>> func8)
        //{
        //    var objs = GetMultiple(sql, parameters, func1, func2, func3, func4, func5, func6, func7, func8);


        //    return Tuple.Create(objs[0] as IEnumerable<T1>, objs[1] as IEnumerable<T2>, objs[2] as IEnumerable<T3>, objs[3] as IEnumerable<T4>, objs[4] as IEnumerable<T5>, objs[5] as IEnumerable<T6>, objs[6] as IEnumerable<T7>,Tuple.Create(objs[7] as IEnumerable<T8>)  );
